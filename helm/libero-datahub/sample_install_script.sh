...
helm upgrade --install datahub-pipeline . --namespace $ENV_NAME --set $CROSSREF_CONFIG_S3_BUCKET,$CROSS_REF_IMPORT_SCHEDULE_INTERVAL,$CORE_DAG_GIT_REPO_URL,$CORE_DAG_REPO_URL_NAME,$CORE_DAG_REPO_INSTALL_PRIORITY,$CORE_DAG_REPO_URL_REF
